          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="insert.php" method="post" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="desc" type="text" id="desc" class="form-control" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="skill" type="text" id="skill" class="form-control" required />
