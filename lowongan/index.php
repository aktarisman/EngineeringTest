...
<div class="col-lg-4">
  ...
  <a href="add.php" class="btn btn-sm btn-warning">Tambah Data <i class="fa fa-arrow-circle-right"></i></a><br /><br />
     ...
     <?php
                 ...
                 $query1 = "SELECT * FROM lowongan where nama_lowongan like '%$qcari%' or job_desc like '%$qcari%' or required_skill like '%$qcari%'";
                    }
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        ...
                        <th><center>Job Desc</center></th>
                        <th><center>Required Skill</center></th>
                    ...
                    <td>
                    	<center>
                        	...
                        	<a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Delete" onclick="return confirm('Anda yakin akan menghapus Data Dokumen <?php echo $data['no_ecr'];?>')" href="delete.php?id=<?php echo $data['id'];?>">
