          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="insert.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="nama" type="text" id="nama" class="form-control" autofocus="on" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="nomor" type="text" id="nomor" class="form-control" required />
                  ...
                  <?php
                              ...
                              <div class="col-sm-10">
                                  <input name="nama_file" id="nama_file" type="file" enctype="multipart/form-data"/>
                              </div>
                          </div>
